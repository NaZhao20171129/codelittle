document.writeln("<br><a href=\"http://bbs.diybl.com/dview50t172086.html\" target=\"_blank\"><span style=\"font-size: 16px;font-weight: bold;line-height:25px;color:red;\">提供虚拟机（intel vt）技术支持<\/span><\/a>");
...
var wzi=" target='_blank'><img src='/images/ico/";
document.writeln("<div class='feedicon'>");
document.writeln("<img src='/images/ico/wz.gif' alt='收藏到网摘'>");
document.writeln("<a href=\"javascript:d=document;window.external.AddFavorite(\'\'+d.location.href+\'\', \'\'+d.title+\'\')\" target=\"_self\"><img src=\"/images/ico/ie.gif\" alt=\"本地收藏\" /></a>");
