...
/***
Replace the old population with the new population. Incorporates elitism using the parameter globalSetup::replaceProportion. If the value of replaceProportion is less than 1.0 then the bottom (100*replaceProportion)% individuals from the current population are replaced by the top (100*replaceProportion)% individuals from the new population.
*/
