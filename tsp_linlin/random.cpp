...
// Returns a uniform random deviate between 0.0 and 1.0. This routine is adopted from Numerical Recipes in C. The function is an implementation of random number generator of L'Ecuyer with Bays-Durham shuffle (this function is ran 2 in Numerical Recipies in C, pp 282.)
// Reference: Press, W., Flannery, B., Teukolsky, S., & Vettering, W. (1989). Numerical Recipes in C. Cambridge: Cambridge University Press. http://lib-www.lanl.gov/numerical/bookcpdf/c7-1.pdf. (http://www.nr.com).
...
///Flip a biased coin. Return 1 if the uniform random deviate is less than the probability else return 0.
...
/// Generate a uniform a random integer within the range [minimum, maximum)
...
// Reference: Press, W., Flannery, B., Teukolsky, S., & Vettering, W. (1989). Numerical Recipes in C. Cambridge: Cambridge University Press. http://lib-www.lanl.gov/numerical/bookcpdf/c7-3.pdf. (http://www.nr.com).
